...
//        AccountVoMappers mappers = AccountVoMappers.INSTANCE;// 不使用mapstruct，使用hutoll的beanutil工具替换他
        // 获取所有的币种
