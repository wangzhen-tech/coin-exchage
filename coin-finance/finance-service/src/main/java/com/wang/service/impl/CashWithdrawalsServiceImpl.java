...
import com.wang.mapper.CashWithdrawalsMapper;
import com.wang.domain.CashWithdrawals;
import com.wang.service.CashWithdrawalsService;
...
import com.wang.mapper.CashWithdrawAuditRecordMapper;
...
//    -------------------------------------------  START ----------------------------------------------------
    ...
    private BigDecimal getCashWithdrawalsAmount(BigDecimal num) {// 通过数量计算金额
    ...
    private void checkUserPayPassword(String payDBPassword, String payPassword) {// 支付密码的校验
    ...
    private void validatePhoneCode(String mobile, String validateCode) {// 校验用户的手机验证码
