...
public class SmsServiceImpl extends ServiceImpl<SmsMapper, Sms> implements SmsService {
     ...
     * @return
     */
    private SendSmsRequest buildSmsRequest(Sms sms) {// 发短信的请求对象
        ...
        sendSmsRequest.setSignName(signConfig.getValue()); // 设置签名---公司里面不会随便的改变--在管理员后台可以通过Config 查询签名
