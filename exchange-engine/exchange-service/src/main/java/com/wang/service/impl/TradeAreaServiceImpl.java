...
import com.wang.mapper.TradeAreaMapper;
...
//import com.wang.mappers.TradeAreaDtoMappers;
import com.wang.vo.MergeDeptVo;
import com.wang.vo.TradeAreaMarketVo;
import com.wang.vo.TradeMarketVo;
...
public class TradeAreaServiceImpl extends ServiceImpl<TradeAreaMapper, TradeArea> implements TradeAreaService {
    ...
    public List<TradeAreaDto> findAllTradeAreaAndMarket() {
        ...
        List<TradeAreaDto> tradeAreaDtoList = BeanUtil.copyToList(tradeAreas, TradeAreaDto.class);
